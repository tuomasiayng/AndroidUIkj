...
import com.yangkai.androiduikj.widget.ExpandTextView;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setRightText(int viewId, CharSequence value) {
        ExpandTextView view = getView(viewId);
        view.setRightText(value);
        return this;
    }

    public BaseViewHolder setRightTextColor(int viewId, int value) {
        ExpandTextView view = getView(viewId);
        view.setRightTextColor(value);
        return this;
    }

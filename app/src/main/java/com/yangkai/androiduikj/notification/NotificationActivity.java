...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
        ...
        @OnClick(R.id.nft_btn1)
        void nftBtn1(View view){
            startActivity(new Intent(getActivity(), Notification1Activity.class));
        }

        @OnClick(R.id.nft_btn2)
        void nftBtn2(View view){
